...
#' @param init \code{\link{vector}} with 4 values: the initial proportion of proportion of susceptibles, infectious, carriers and recovered. The names of these values must be "S", "I", "C" and "R", respectively. All parameters must be positive and S + I + C + R <= 1.
...
#'                     epsilon = 0.1, rho = 0.4)
#' initials <- c(S = 0.1, I = 1e-4, C = 1e-3,  R = 0)
#' 
#' # Solve the system.
