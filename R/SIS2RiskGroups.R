...
#' @param init \code{\link{vector}} with 2 values: the initial proportion of infectious in the high-risk group and the intial proportion of infectious in the low-risk group. The names of these values must be "IH" and "IL", respectively. All parameters must be positive and  nH <= 1, IH(0) <= nH, IL(0) <= 1-nH.
...
#' 
#' # Solve the system.
#' sis2risk.hroups<- SIS2RiskGroups(pars = parameters,
